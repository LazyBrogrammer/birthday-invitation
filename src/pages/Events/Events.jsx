...
export const Events = () => {
  ...
  const [subEvent, setSubEvent] = useState([{ partName: "", startTime: "", endTime: "", location: "", instruction: "", note: "" }]);
      ...
      <div className="events-container">
        <div className="events">
          ...
          <form className="event-form" onSubmit={handleSubmit}>
            ...
            <h3>Guests</h3>
            <button type="button" className="add-button" onClick={() => setGuests([...guests, { email: "", name: "", role: "GUEST" }])}>
              Add Guest
            </button>
            <div className="guests-container">
              {guests.map((guest, index) => (
                  <div key={index} className="guest-item">
                    ...
                    {guests.length > 1 && (
                        <button type="button" className="remove-button" onClick={() => setGuests(guests.filter((_, i) => i !== index))}>
                          Remove
                        </button>
                    )}
                  </div>
            ...
            <h3>Sub-Events</h3>
            <button type="button" className="add-button" onClick={() => setSubEvent([...subEvent, { partName: "", startTime: "", endTime: "", location: "", instruction: "", note: "" }])}>
              Add Sub-Event
            </button>
            <div className="subevents-container">
              {subEvent.map((sub, index) => (
                  <div key={index} className="subevent-item">
                    ...
                    />
                    {subEvent.length > 1 && (
                        <button type="button" className="remove-button" onClick={() => setSubEvent(subEvent.filter((_, i) => i !== index))}>
                          Remove Sub-Event
                        </button>
                    )}
                  </div>
